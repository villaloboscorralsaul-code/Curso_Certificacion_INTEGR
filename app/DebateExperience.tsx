...
type Props = { debates: DebateCase[]; completed: boolean; onComplete: () => void; onBack: () => void; moduleLabel?: string };
...
export default function DebateExperience({ debates, completed, onComplete, onBack, moduleLabel = "MÓDULO I" }: Props) {
